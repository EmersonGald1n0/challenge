  ...
  return (
    <div className={styles.servicos}>
      ...
      <div className={styles.bloco1}>
        <figcaption>
          <img className={styles.serv1} src={serv1} alt="" />
          <p className={styles.text1}><span className={styles.span}>#</span>Desenvolvimento em IA & <span className={styles.span}>Machine Learning</span></p>
        </figcaption>
      </div>
      <div className={styles.bloco2}>
        <figcaption>
          <img className={styles.serv2} src={serv2} alt="" />
      ...
      <div className={styles.bloco3}>
        <figcaption>
          <img className={styles.serv3} src={serv3} alt="" />
      ...
      <div className={styles.bloco4}>
        <figcaption>
          <img className={styles.serv4} src={serv4} alt="" />
      ...
      <div className={styles.bloco5}>
        <figcaption>
          <img className={styles.serv5} src={serv5} alt="" />
      ...
      <div className={styles.bloco6}>
        <figcaption>
          <img className={styles.serv6} src={serv6} alt="" />
      ...
      <h1 className={styles.title2}>ENTRE OUTRAS <span className={styles.span}>OPORTUNIDADES INCRÍVEIS</span> PARA VOCÊ INSCREVA-SE JÁ!!!</h1>
    </div>
